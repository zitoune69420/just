...
export const fr: Messages = {
  ...
  "report.description":
    "Le catalogue vient de TMDB, la lecture d’une autre source : certains titres sont annoncés sans être lisibles. Le signaler permet de les retirer.",
  "report.reason.unavailable": "Rien ne se lance",
  "report.reason.unavailableHint": "Le lecteur reste vide ou affiche une erreur.",
  "report.reason.wrong-title": "Mauvais titre",
  "report.reason.wrong-titleHint": "C’est un autre film ou un autre épisode.",
  "report.reason.playback": "Lecture défaillante",
  "report.reason.playbackHint": "Ça coupe, ça gèle ou ça ne charge jamais.",
  "report.reason.subtitles": "Problème de sous-titres",
  "report.reason.subtitlesHint": "Absents, décalés ou dans la mauvaise langue.",
  "report.submit": "Envoyer le signalement",
  "report.pending": "Envoi…",
  "report.cancel": "Annuler",
  "report.done": "Merci — le signalement est enregistré.",
  "report.duplicate": "Vous aviez déjà signalé ce titre.",
  "report.signInRequired": "Connectez-vous pour signaler un titre.",
  "report.error":
    "Le signalement n’a pas pu être enregistré. Réessayez plus tard.",
  "report.throttled":
  ...
  "admin.reportsDescription":
    "Titres annoncés au catalogue que des comptes n’ont pas pu regarder.",
  "admin.reportsEmpty": "Aucun signalement ouvert.",
  "admin.reportsResolvedEmpty": "Aucun signalement traité.",
  "admin.reportsOpen": "Ouverts",
  "admin.reportsResolved": "Traités",
  "admin.reportTitleColumn": "Titre",
  "admin.reportReason": "Problème",
  "admin.reportReporter": "Signalé par",
